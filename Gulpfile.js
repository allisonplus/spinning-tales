...
gulp.task('wp-pot', ['clean:pot'], function() {
	...
	.pipe(wpPot({
		...
		destFile:'cps.pot',
		package: 'spin',
		bugReport: 'http://localhost:8888/spin',
		lastTranslator: 'John Doe <mail@localhost:8888/spin>',
		team: 'Team <mail@localhost:8888/spin>'
	}))
...
gulp.task('watch', function() {
	...
	browserSync({
		...
		proxy: "http://localhost:8888/spin:3000", // Use http://localhost:8888/spin:3000 to use BrowserSync
		watchOptions: {
